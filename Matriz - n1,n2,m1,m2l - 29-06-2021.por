...
/*
 ...
 a) Uma matriz M1 cujos elementos serão somas dos elementos de mesma posição das matrizes N1 e N2;
 b) Uma matriz M2 cujos elementos serão diferentes dos elementos de mesma posição das matrizes N1 e N2.
*/
